...
describe('single file diagnostics', () => {
  ...
  it('should enable strict mode by default when paths are not provided', async () => {
    // when
  ...
  it('should not enable strict mode when paths are not provided and file contains ignore comment', async () => {
    // when
    const diagnostics = await getDiagnostics(
      FILE_CONTENT_WITH_IGNORE,
      '../project-fixture-default/index.ts',
